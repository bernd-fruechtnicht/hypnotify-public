...
- **Content**: Soft, ambient music suitable for meditation

## Recommended Audio Characteristics
- **Tempo**: Slow, calming (60-80 BPM)
- **Instruments**: Soft strings, gentle piano, nature sounds
- **Volume**: Quiet background level (not dominating)
- **Style**: Ambient, new age, or classical meditation music

## How It Works
- **Automatic**: Starts when meditation session begins
- **Looping**: Repeats seamlessly throughout the session
- **Volume Control**: Independent of speech volume
- **Pause/Resume**: Follows session pause/resume
- **Stop**: Stops when session ends
...
- Fade in/out effects
- Music selection per session type
